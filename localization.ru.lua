...
SMARTBUFF_DRUID = { };
SMARTBUFF_DRUID[1] = {"Знак дикой природы", 30, SMARTBUFF_CONST_GROUP, {1,10,20,30,40,50,60}, "WPET", "Дар дикой природы", 60, {50,60}, {"Лесные ягоды","Дикий шипокорень"}};
...
SMARTBUFF_TEMPLATES = {"Соло", "Группа", "Рейд", "Поле боя", "ОН", "Они", "ЛКТ", "АК", "ЗГ", "Своё 1", "Своё 2", "Своё 3", "Своё 4", "Своё 5"};
...
SMARTBUFF_OFT_AUTOSWITCHTMP  = "Переключаю настройки";
